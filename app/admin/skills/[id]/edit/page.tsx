...
// Mock skill data - replace with actual API call
const mockSkill = {
  id: 1,
  name: 'React',
  category: 'Frontend',
  ...
  longDescription: 'Extensive experience with React ecosystem including hooks, context API, custom hooks, performance optimization, and advanced patterns. Built scalable applications with React Router, state management solutions, and modern build tools.',
  status: 'Active',
  featured: true,
  icon: '⚛️',
  tags: ['JavaScript', 'JSX', 'Hooks', 'Context', 'Performance'],
  relatedSkills: ['TypeScript', 'Next.js', 'Redux', 'Styled Components'],
  ...
  learningGoals: 'Master React 18 concurrent features, explore React Server Components, and improve performance optimization techniques.',
  resources: 'React Documentation, Kent C. Dodds courses, React Patterns by Michael Chan, Advanced React by Frontend Masters',
  notes: 'React is my primary frontend framework. I enjoy exploring new patterns and staying updated with the latest features. Strong focus on performance and accessibility.'
};
      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400">Loading skill...</p>
          </div>
        </div>
      </AdminLayout>
    );
