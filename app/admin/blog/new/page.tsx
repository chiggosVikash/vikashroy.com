...
const tags = [
  'React', 'Next.js', 'Node.js', 'TypeScript', 'JavaScript', 'Python', 'Flutter', 'Dart', 'MongoDB', 
  'PostgreSQL', 'Docker', 'AWS', 'Firebase', 'GraphQL', 'REST API', 'Tailwind CSS', 'Performance',
  'Best Practices', 'Architecture', 'Testing', 'Security', 'Accessibility', 'SEO', 'Mobile First'
];
      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Write New Blog Post</h1>
